...
public class BasisController {
    ...
    @ApiOperation("获取全局配置参数")
    public Result listWhiteList(@ApiParam("1 为文本 ，2为对象 ，3 为数组") @RequestParam Integer type, @ApiParam("code") String code) {
        return this.basisService.globalConfig(type,code);
    }
